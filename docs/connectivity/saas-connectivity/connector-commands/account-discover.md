...
This code produces the following payload that will be sent back to SHF.
...
SHF then asks you to assign attributes to ‘Account ID’ and 'Account Name.'
