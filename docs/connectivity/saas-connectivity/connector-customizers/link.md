...
Before you can link a connector customizer to a source, you must have a SaaS source in SailPoint Human Fabric, as well as a Customizer built and deployed. You can use the following commands to get a list of valid sources, as well as customizers:
