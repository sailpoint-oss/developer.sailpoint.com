...
description: Using the CLI to properly test and debug your connector in SailPoint Human Fabric
slug: /connectivity/saas-connectivity/in-depth/cli-advanced
tags: ['Connectivity']
---

You can use the CLI to invoke a number of calls in SailPoint Human Fabric, including calls that aren't specifically defined by the CLI. This section includes examples that show how you can invoke those calls:
