...
A convenient way to test your connector before deploying to SHF is to use Postman. You can get it from the [postman.com downloads page](https://www.postman.com/downloads/)
...
- **connector-spec.ts** This file describes how the connector works to SHF. More information about the connector spec is available in the next section. At a high level, it has the information for the following:
  ...
  - Defining the account create template that maps fields from SHF to the connector
