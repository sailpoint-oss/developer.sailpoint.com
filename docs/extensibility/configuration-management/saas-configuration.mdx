...
[This endpoint](https://developer.sailpoint.com/docs/api/beta/get-sp-config-export-status) gets the status of the export job identified by its `id` parameter.
...
[This endpoint](https://developer.sailpoint.com/docs/api/beta/get-sp-config-export) gets the export job's resulting export file by using the requested `id` and downloads it to a file.
...
[This endpoint](https://developer.sailpoint.com/docs/api/beta/get-sp-config-import-status) gets the status of the import job identified by its `id` parameter. 
...
[This endpoint](https://developer.sailpoint.com/docs/api/beta/get-sp-config-import) gets the import job's resulting import file by using the requested `id` and downloads the file. 
