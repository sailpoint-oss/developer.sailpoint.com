...
For a list of supported connectors and features, see [Supported Connectors for SailPoint Human Fabric](https://community.sailpoint.com/t5/IdentityNow-Connectors/Identity-Security-Cloud-Connectors/ta-p/80019).
...
> **NOTE:** There is no indication to the approver in the SailPoint Human Fabric UI that the approval is for a revoke action. This must be considered for all usage of these APIs.
