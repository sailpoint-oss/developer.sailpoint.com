...
If you want to control the test input to validate your filter against a more robust set of data, you can use the [test invocation](/docs/api/start-test-trigger-invocation-v-1) API endpoint. You can use this API to send an input payload with any values that you want. This is an example of an invocation of this API:
...
You can also view the activity log by using the [list latest invocation statuses](/docs/api/list-trigger-invocation-status-v-1) endpoint.
