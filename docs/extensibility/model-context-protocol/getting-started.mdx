...
- **Valid authentication credentials** - refer to our [Authentication documentation](../../api/v2025/authentication.md) for details
...
1. Select the **Authentication** tab in the MCP Inspector
...
Select `List Tools` to see the available tools. If the connection is successful, you will see a list of tools:
