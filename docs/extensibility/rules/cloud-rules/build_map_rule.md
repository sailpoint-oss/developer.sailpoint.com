...
- **Cloud Execution** - This rule executes in the SailPoint Human Fabric cloud, and has read-only access to the records from the Delimited File being imported. However, it doesn't have access to on-premise sources or connectors.
