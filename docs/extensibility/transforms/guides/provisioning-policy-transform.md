...
In this guide, you will learn how to use [SailPoint Human Fabric's Transforms](/docs/api/transforms) in a provisioning policy for a source. This can be useful if you need to hide the attribute in your identity attribute list but still need the attribute during provisioning.
