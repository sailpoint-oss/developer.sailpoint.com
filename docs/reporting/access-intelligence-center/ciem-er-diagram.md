...
<MermaidViewer diagram='erDiagram
    "Entitlement Service Usage" {
        varchar ENTITLEMENT_VALUE PK "SailPoint Human Fabric entitlement value associated with the access. Usually the cloud native ID."
        ...
        varchar ENTITLEMENT_ACCOUNT_NATIVE_IDENTITY "Account native id"
        ...
        varchar SOURCE_NAME "SailPoint Human Fabric source name associated with the cloud service"
    ...
    "Resource Access" {
        ...
        varchar RESOURCE_ACCESS_SOURCE_NAME "SailPoint Human Fabric source name associated with the resource"
    }
    ENTITLEMENT {
        varchar ENTITLEMENT_VALUE PK "SailPoint Human Fabric entitlement value associated with the access. Usually the cloud native ID."
        varchar ENTITLEMENT_ATTRIBUTE "Entitlement type as determined by SailPoint Human Fabric sources"
        varchar ENTITLEMENT_DISPLAY_NAME "Human readable name of the entitlement as constructed by SailPoint Human Fabric"
    ...
    IDENTITY {
        ...
        timestamp IDENTITY_CREATED "Identity created date in SailPoint Human Fabric"
        timestamp IDENTITY_UPDATED "Identity modified date in SailPoint Human Fabric"
        ...
        varchar MANAGERS_NAME "Name of the manager of the identity"
    ...
    ACCOUNT {
        ...
        varchar IDENTITY_ID PK "SailPoint Human Fabric unique identifier of the identity correlated with the account (null if uncorrelated)"
        varchar ACCOUNT_ID "SailPoint Human Fabric unique identifier of account"
        varchar ACCOUNT_NAME "Name of account as configured in SailPoint Human Fabric"
        varchar ACCOUNT_CREATED_DATE "Account creation date (ingestion/creation in SailPoint Human Fabric)"
        varchar ACCOUNT_UPDATED_DATE "Account update date (updated in SailPoint Human Fabric)"
        varchar ACCOUNT_DISPLAY_NAME "Display name of account as configured in SailPoint Human Fabric"
