...
<MermaidViewer diagram='erDiagram
    IDENTITY_ACCOUNTS {
        ...
        timestamp_ltz IDENTITY_SYNC_DATE "When the identity record was last synced"
        timestamp_ltz ACCOUNT_SYNC_DATE "When the account record was last synced"
        timestamp_ltz SOURCE_SYNC_DATE "When the source record was last synced"
    }
    ...
    ACCOUNT {
        ...
        timestamp_ntz CREATED_DATE "date when the account was created"
        timestamp_ntz UPDATED_DATE "date when the account was modified"
        timestamp_ntz DELETED_DATE "date when the account was deleted"
    ...
    ACCOUNT_ENTITLEMENTS {
        ...
        timestamp_ntz UPDATED_DATE "date when the relationship was modified"
        timestamp_ntz DELETED_DATE "date when the relationship was deleted"
        timestamp_ltz SYNC_DATE "When the row is last synced"
    }
    CERTIFICATION_CAMPAIGN {
        ...
        timestamp_ntz DELETED_DATE "date when the campaign was deleted"
        text STATUS "Status of the campaign Ex: Active, Completed etc."
        timestamp_ntz DEADLINE "Deadline for the campaign"
