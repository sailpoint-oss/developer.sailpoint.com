...
Everything inside this searchQuery object matches the standard format of an [SailPoint Human Fabric search query](https://documentation.sailpoint.com/saas/help/search/building-query.html). A limited number of examples are provided [here](https://developer.sailpoint.com/docs/api/search-post-v-1), but the searchQuery object is mapped to the full search object. This means that you can add any search query values missing from this object.
