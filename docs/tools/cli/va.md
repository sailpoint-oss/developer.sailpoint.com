...
A virtual appliance (VA) is a Linux-based virtual machine that connects to your sources and applications in SHF by using APIs, connectors, and other integrations SailPoint has made available.
