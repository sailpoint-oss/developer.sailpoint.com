...
The 'Username Generator' rule uses the `AttributeGenerator` rule type. See [Attribute Generator](/extensibility/rules/cloud-rules/account-profile-attribute-generator#input) for the available inputs.
