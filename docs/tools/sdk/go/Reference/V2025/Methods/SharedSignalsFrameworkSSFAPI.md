...
keywords: ['go', 'Golang', 'sdk', 'SharedSignalsFrameworkSSF', 'V2025SharedSignalsFrameworkSSF'] 
slug: /tools/sdk/go/v2025/methods/shared-signals-framework-ssf
tags: ['SDK', 'Software Development Kit', 'SharedSignalsFrameworkSSF', 'V2025SharedSignalsFrameworkSSF']
---
...
func main() {
    ...
    var createStreamRequest v2025.CreateStreamRequest
    ...
    resp, r, err := apiClient.V2025.SharedSignalsFrameworkSSFAPI.CreateStream(context.Background()).CreateStreamRequest(createStreamRequest).Execute()
	  //resp, r, err := apiClient.V2025.SharedSignalsFrameworkSSFAPI.CreateStream(context.Background()).CreateStreamRequest(createStreamRequest).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.V2025.SharedSignalsFrameworkSSFAPI.DeleteStream(context.Background()).StreamId(streamId).Execute()
	  //r, err := apiClient.V2025.SharedSignalsFrameworkSSFAPI.DeleteStream(context.Background()).StreamId(streamId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.V2025.SharedSignalsFrameworkSSFAPI.GetJWKSData(context.Background()).Execute()
	  //resp, r, err := apiClient.V2025.SharedSignalsFrameworkSSFAPI.GetJWKSData(context.Background()).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.V2025.SharedSignalsFrameworkSSFAPI.GetSSFConfiguration(context.Background()).Execute()
	  //resp, r, err := apiClient.V2025.SharedSignalsFrameworkSSFAPI.GetSSFConfiguration(context.Background()).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.V2025.SharedSignalsFrameworkSSFAPI.GetStream(context.Background()).Execute()
	  //resp, r, err := apiClient.V2025.SharedSignalsFrameworkSSFAPI.GetStream(context.Background()).StreamId(streamId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.V2025.SharedSignalsFrameworkSSFAPI.GetStreamStatus(context.Background()).StreamId(streamId).Execute()
	  //resp, r, err := apiClient.V2025.SharedSignalsFrameworkSSFAPI.GetStreamStatus(context.Background()).StreamId(streamId).Execute()
    if err != nil {
...
func main() {
    ...
    var verificationRequest v2025.VerificationRequest
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.V2025.SharedSignalsFrameworkSSFAPI.SendStreamVerification(context.Background()).VerificationRequest(verificationRequest).Execute()
	  //r, err := apiClient.V2025.SharedSignalsFrameworkSSFAPI.SendStreamVerification(context.Background()).VerificationRequest(verificationRequest).Execute()
    if err != nil {
...
func main() {
    ...
    var replaceStreamConfigurationRequest v2025.ReplaceStreamConfigurationRequest
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.V2025.SharedSignalsFrameworkSSFAPI.SetStreamConfiguration(context.Background()).ReplaceStreamConfigurationRequest(replaceStreamConfigurationRequest).Execute()
	  //resp, r, err := apiClient.V2025.SharedSignalsFrameworkSSFAPI.SetStreamConfiguration(context.Background()).ReplaceStreamConfigurationRequest(replaceStreamConfigurationRequest).Execute()
    if err != nil {
...
func main() {
    ...
    var updateStreamConfigurationRequest v2025.UpdateStreamConfigurationRequest
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.V2025.SharedSignalsFrameworkSSFAPI.UpdateStreamConfiguration(context.Background()).UpdateStreamConfigurationRequest(updateStreamConfigurationRequest).Execute()
	  //resp, r, err := apiClient.V2025.SharedSignalsFrameworkSSFAPI.UpdateStreamConfiguration(context.Background()).UpdateStreamConfigurationRequest(updateStreamConfigurationRequest).Execute()
    if err != nil {
...
func main() {
    ...
    var updateStreamStatusRequest v2025.UpdateStreamStatusRequest
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.V2025.SharedSignalsFrameworkSSFAPI.UpdateStreamStatus(context.Background()).UpdateStreamStatusRequest(updateStreamStatusRequest).Execute()
	  //resp, r, err := apiClient.V2025.SharedSignalsFrameworkSSFAPI.UpdateStreamStatus(context.Background()).UpdateStreamStatusRequest(updateStreamStatusRequest).Execute()
    if err != nil {
