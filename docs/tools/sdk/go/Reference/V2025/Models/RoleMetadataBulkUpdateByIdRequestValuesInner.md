...
keywords: ['go', 'Golang', 'sdk', 'RoleMetadataBulkUpdateByIdRequestValuesInner', 'RoleMetadataBulkUpdateByIdRequestValuesInner'] 
slug: /tools/sdk/go//models/role-metadata-bulk-update-by-id-request-values-inner
