...
keywords: ['go', 'Golang', 'sdk', 'AccessRequestIdentityMetrics', 'V2026AccessRequestIdentityMetrics'] 
slug: /tools/sdk/go/v2026/methods/access-request-identity-metrics
tags: ['SDK', 'Software Development Kit', 'AccessRequestIdentityMetrics', 'V2026AccessRequestIdentityMetrics']
---
...
func main() {
    ...
    resp, r, err := apiClient.V2026.AccessRequestIdentityMetricsAPI.GetAccessRequestIdentityMetrics(context.Background(), identityId, requestedObjectId, type_).Execute()
	  //resp, r, err := apiClient.V2026.AccessRequestIdentityMetricsAPI.GetAccessRequestIdentityMetrics(context.Background(), identityId, requestedObjectId, type_).Execute()
    if err != nil {
