...
keywords: ['go', 'Golang', 'sdk', 'AccountAggregations', 'V2026AccountAggregations'] 
slug: /tools/sdk/go/v2026/methods/account-aggregations
tags: ['SDK', 'Software Development Kit', 'AccountAggregations', 'V2026AccountAggregations']
---
...
func main() {
    ...
    resp, r, err := apiClient.V2026.AccountAggregationsAPI.GetAccountAggregationStatus(context.Background(), id).Execute()
	  //resp, r, err := apiClient.V2026.AccountAggregationsAPI.GetAccountAggregationStatus(context.Background(), id).Execute()
    if err != nil {
