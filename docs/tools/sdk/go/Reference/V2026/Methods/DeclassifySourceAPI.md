...
keywords: ['go', 'Golang', 'sdk', 'DeclassifySource', 'V2026DeclassifySource'] 
slug: /tools/sdk/go/v2026/methods/declassify-source
tags: ['SDK', 'Software Development Kit', 'DeclassifySource', 'V2026DeclassifySource']
---
...
func main() {
    ...
    r, err := apiClient.V2026.DeclassifySourceAPI.SendDeclassifyMachineAccountFromSource(context.Background(), sourceId).Execute()
	  //r, err := apiClient.V2026.DeclassifySourceAPI.SendDeclassifyMachineAccountFromSource(context.Background(), sourceId).Execute()
    if err != nil {
