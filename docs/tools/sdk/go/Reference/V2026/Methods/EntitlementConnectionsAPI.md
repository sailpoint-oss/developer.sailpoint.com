...
keywords: ['go', 'Golang', 'sdk', 'EntitlementConnections', 'V2026EntitlementConnections'] 
slug: /tools/sdk/go/v2026/methods/entitlement-connections
tags: ['SDK', 'Software Development Kit', 'EntitlementConnections', 'V2026EntitlementConnections']
---
...
Other parameters are passed through a pointer to a apiListEntitlementConnectionsRequest struct via the builder pattern
...
func main() {
    ...
    resp, r, err := apiClient.V2026.EntitlementConnectionsAPI.ListEntitlementConnections(context.Background()).Execute()
	  //resp, r, err := apiClient.V2026.EntitlementConnectionsAPI.ListEntitlementConnections(context.Background()).Offset(offset).Limit(limit).Count(count).SearchAfter(searchAfter).Filters(filters).Sorters(sorters).Execute()
    if err != nil {
	    fmt.Fprintf(os.Stderr, "Error when calling `EntitlementConnectionsAPI.ListEntitlementConnections``: %v\n", err)
	    fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `ListEntitlementConnections`: []EntitlementConnectionSearchHit
    fmt.Fprintf(os.Stdout, "Response from `EntitlementConnectionsAPI.ListEntitlementConnections`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiListEntitlementConnectionsForCurrentIdentityRequest struct via the builder pattern
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.V2026.EntitlementConnectionsAPI.ListEntitlementConnectionsForCurrentIdentity(context.Background()).Execute()
	  //resp, r, err := apiClient.V2026.EntitlementConnectionsAPI.ListEntitlementConnectionsForCurrentIdentity(context.Background()).Offset(offset).Limit(limit).Count(count).SearchAfter(searchAfter).Filters(filters).Sorters(sorters).Execute()
    if err != nil {
	    fmt.Fprintf(os.Stderr, "Error when calling `EntitlementConnectionsAPI.ListEntitlementConnectionsForCurrentIdentity``: %v\n", err)
	    fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `ListEntitlementConnectionsForCurrentIdentity`: []EntitlementConnectionSearchHit
    fmt.Fprintf(os.Stdout, "Response from `EntitlementConnectionsAPI.ListEntitlementConnectionsForCurrentIdentity`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchEntitlementConnectionByIdRequest struct via the builder pattern
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.V2026.EntitlementConnectionsAPI.PatchEntitlementConnectionById(context.Background(), connectionId).JsonPatchOperation(jsonPatchOperation).Execute()
	  //resp, r, err := apiClient.V2026.EntitlementConnectionsAPI.PatchEntitlementConnectionById(context.Background(), connectionId).JsonPatchOperation(jsonPatchOperation).Execute()
    if err != nil {
	    fmt.Fprintf(os.Stderr, "Error when calling `EntitlementConnectionsAPI.PatchEntitlementConnectionById``: %v\n", err)
	    fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PatchEntitlementConnectionById`: EntitlementConnection
    fmt.Fprintf(os.Stdout, "Response from `EntitlementConnectionsAPI.PatchEntitlementConnectionById`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchEntitlementConnectionByQueryRequest struct via the builder pattern
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.V2026.EntitlementConnectionsAPI.PatchEntitlementConnectionByQuery(context.Background()).EntitlementId(entitlementId).IdentityId(identityId).AccountId(accountId).JsonPatchOperation(jsonPatchOperation).Execute()
	  //resp, r, err := apiClient.V2026.EntitlementConnectionsAPI.PatchEntitlementConnectionByQuery(context.Background()).EntitlementId(entitlementId).IdentityId(identityId).AccountId(accountId).JsonPatchOperation(jsonPatchOperation).Execute()
    if err != nil {
	    fmt.Fprintf(os.Stderr, "Error when calling `EntitlementConnectionsAPI.PatchEntitlementConnectionByQuery``: %v\n", err)
	    fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PatchEntitlementConnectionByQuery`: EntitlementConnection
    fmt.Fprintf(os.Stdout, "Response from `EntitlementConnectionsAPI.PatchEntitlementConnectionByQuery`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUpdateEntitlementConnectionsBulkRequest struct via the builder pattern
...
func main() {
    ...
    var entitlementConnectionBulkUpdateItem []v2026.EntitlementConnectionBulkUpdateItem
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    resp, r, err := apiClient.V2026.EntitlementConnectionsAPI.UpdateEntitlementConnectionsBulk(context.Background()).EntitlementConnectionBulkUpdateItem(entitlementConnectionBulkUpdateItem).Execute()
	  //resp, r, err := apiClient.V2026.EntitlementConnectionsAPI.UpdateEntitlementConnectionsBulk(context.Background()).EntitlementConnectionBulkUpdateItem(entitlementConnectionBulkUpdateItem).Execute()
    if err != nil {
	    fmt.Fprintf(os.Stderr, "Error when calling `EntitlementConnectionsAPI.UpdateEntitlementConnectionsBulk``: %v\n", err)
	    fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `UpdateEntitlementConnectionsBulk`: []EntitlementConnectionBulkUpdateResultItem
    fmt.Fprintf(os.Stdout, "Response from `EntitlementConnectionsAPI.UpdateEntitlementConnectionsBulk`: %v\n", resp)
}
```
