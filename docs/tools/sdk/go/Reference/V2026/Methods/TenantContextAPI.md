...
func main() {
    ...
    resp, r, err := apiClient.V2026.TenantContextAPI.GetTenantContext(context.Background()).Execute()
	  //resp, r, err := apiClient.V2026.TenantContextAPI.GetTenantContext(context.Background()).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := sailpoint.NewDefaultConfiguration()
    apiClient := sailpoint.NewAPIClient(configuration)
    r, err := apiClient.V2026.TenantContextAPI.PatchTenantContext(context.Background()).JsonPatchOperation(jsonPatchOperation).Execute()
	  //r, err := apiClient.V2026.TenantContextAPI.PatchTenantContext(context.Background()).JsonPatchOperation(jsonPatchOperation).Execute()
    if err != nil {
