...
------------ | ------------- | ------------- | -------------
**Values** |  [**[]SystemCollectionsHashtable**](system-collections-hashtable) | An array of items to join together | 
...
```powershell
$Concatenation = Initialize-PSSailpointBetaConcatenation  -Values [John,  , Smith] `
