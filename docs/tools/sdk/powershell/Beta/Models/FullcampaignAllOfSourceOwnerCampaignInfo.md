...
```powershell
$FullcampaignAllOfSourceOwnerCampaignInfo = Initialize-PSSailpointBetaFullcampaignAllOfSourceOwnerCampaignInfo  -SourceIds [0fbe863c063c4c88a35fd7f17e8a3df5]
```
