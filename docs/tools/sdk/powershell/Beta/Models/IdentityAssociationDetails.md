...
```powershell
$IdentityAssociationDetails = Initialize-PSSailpointBetaIdentityAssociationDetails  -Message Identity cannot be deleted as it is owner of following resources `
