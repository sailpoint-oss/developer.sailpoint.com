...
```powershell
$RequestedItemStatusCancelledRequestDetails = Initialize-PSSailpointBetaRequestedItemStatusCancelledRequestDetails  -Comment This request must be cancelled. `
 -Owner null `
