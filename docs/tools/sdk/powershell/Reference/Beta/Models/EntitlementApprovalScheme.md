...
keywords: ['powershell', 'PowerShell', 'sdk', 'EntitlementApprovalScheme', 'BetaEntitlementApprovalScheme'] 
...
**ApproverId** | **String** | Id of the specific approver, used only when approverType is GOVERNANCE_GROUP or WORKFLOW | [optional] 
