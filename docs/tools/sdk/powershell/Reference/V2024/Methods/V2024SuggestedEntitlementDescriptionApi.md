...
try {
    $Result = ConvertFrom-V2024JsonToSedPatch -Json $SedPatch
...
try {
    $Result = ConvertFrom-V2024JsonToSedApproval -Json $SedApproval
...
try {
    $Result = ConvertFrom-V2024JsonToSedAssignment -Json $SedAssignment
