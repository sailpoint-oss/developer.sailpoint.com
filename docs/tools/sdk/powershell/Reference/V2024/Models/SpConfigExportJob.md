...
keywords: ['powershell', 'PowerShell', 'sdk', 'SpConfigExportJob', 'V2024SpConfigExportJob'] 
slug: /tools/sdk/powershell/v2024/models/sp-config-export-job
...
```powershell
$SpConfigExportJob = Initialize-PSSailpoint.V2024SpConfigExportJob  -JobId 3469b87d-48ca-439a-868f-2160001da8c1 `
 -Status COMPLETE `
 -Type IMPORT `
