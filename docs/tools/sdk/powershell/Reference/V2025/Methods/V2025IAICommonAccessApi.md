...
try {
    $Result = ConvertFrom-V2025JsonToCommonAccessItemRequest -Json $CommonAccessItemRequest
...
try {
    $Result = ConvertFrom-V2025JsonToCommonAccessIDStatus -Json $CommonAccessIDStatus
