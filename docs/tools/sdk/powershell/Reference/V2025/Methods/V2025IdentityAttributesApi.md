...
try {
    $Result = ConvertFrom-V2025JsonToIdentityAttribute -Json $IdentityAttribute
...
try {
    $Result = ConvertFrom-V2025JsonToIdentityAttributeNames -Json $IdentityAttributeNames
