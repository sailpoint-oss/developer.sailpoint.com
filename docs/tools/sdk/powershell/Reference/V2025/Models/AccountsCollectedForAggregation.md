...
keywords: ['powershell', 'PowerShell', 'sdk', 'AccountsCollectedForAggregation', 'V2025AccountsCollectedForAggregation'] 
...
```powershell
$AccountsCollectedForAggregation = Initialize-PSSailpoint.V2025AccountsCollectedForAggregation  -Source null `
 -Status Success `
