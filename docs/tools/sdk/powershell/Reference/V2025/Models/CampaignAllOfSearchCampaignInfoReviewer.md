...
keywords: ['powershell', 'PowerShell', 'sdk', 'CampaignAllOfSearchCampaignInfoReviewer', 'V2025CampaignAllOfSearchCampaignInfoReviewer'] 
...
```powershell
$CampaignAllOfSearchCampaignInfoReviewer = Initialize-PSSailpoint.V2025CampaignAllOfSearchCampaignInfoReviewer  -Type IDENTITY `
