...
keywords: ['powershell', 'PowerShell', 'sdk', 'CampaignReference', 'V2025CampaignReference'] 
slug: /tools/sdk/powershell/v2025/models/campaign-reference
...
```powershell
$CampaignReference = Initialize-PSSailpoint.V2025CampaignReference  -Id ef38f94347e94562b5bb8424a56397d8 `
 -Name Campaign Name `
 -Type CAMPAIGN `
