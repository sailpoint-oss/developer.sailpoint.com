...
keywords: ['powershell', 'PowerShell', 'sdk', 'CampaignReportsConfig', 'V2025CampaignReportsConfig'] 
...
```powershell
$CampaignReportsConfig = Initialize-PSSailpoint.V2025CampaignReportsConfig  -IdentityAttributeColumns [firstname, lastname]
```
