...
```powershell
$CompletedApprovalPreApprovalTriggerResult = Initialize-PSSailpoint.V2025CompletedApprovalPreApprovalTriggerResult  -Comment This request was autoapproved by our automated ETS subscriber `
 -Decision null `
