...
keywords: ['powershell', 'PowerShell', 'sdk', 'ConnectorRuleCreateRequest', 'V2025ConnectorRuleCreateRequest'] 
slug: /tools/sdk/powershell/v2025/models/connector-rule-create-request
...
```powershell
$ConnectorRuleCreateRequest = Initialize-PSSailpoint.V2025ConnectorRuleCreateRequest  -Name WebServiceBeforeOperationRule `
