...
```powershell
$DependantAppConnectionsAccountSourcePasswordPoliciesInner = Initialize-PSSailpoint.V2025DependantAppConnectionsAccountSourcePasswordPoliciesInner  -Type PASSWORD_POLICY `
