...
keywords: ['powershell', 'PowerShell', 'sdk', 'FullDiscoveredApplications', 'V2025FullDiscoveredApplications'] 
slug: /tools/sdk/powershell/v2025/models/full-discovered-applications
...
```powershell
$FullDiscoveredApplications = Initialize-PSSailpoint.V2025FullDiscoveredApplications  -Id null `
 -Name ExampleApp `
 -DiscoverySource csv `
