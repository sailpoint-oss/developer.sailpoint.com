...
keywords: ['powershell', 'PowerShell', 'sdk', 'IdentityProfileAllOfOwner', 'V2025IdentityProfileAllOfOwner'] 
...
```powershell
$IdentityProfileAllOfOwner = Initialize-PSSailpoint.V2025IdentityProfileAllOfOwner  -Type IDENTITY `
