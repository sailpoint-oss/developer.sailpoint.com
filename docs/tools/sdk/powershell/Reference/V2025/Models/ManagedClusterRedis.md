...
keywords: ['powershell', 'PowerShell', 'sdk', 'ManagedClusterRedis', 'V2025ManagedClusterRedis'] 
...
```powershell
$ManagedClusterRedis = Initialize-PSSailpoint.V2025ManagedClusterRedis  -RedisHost megapod-useast1-shared-redis.cloud.sailpoint.com `
 -RedisPort 6379
```
