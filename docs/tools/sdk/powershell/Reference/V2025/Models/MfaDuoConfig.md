...
keywords: ['powershell', 'PowerShell', 'sdk', 'MfaDuoConfig', 'V2025MfaDuoConfig'] 
slug: /tools/sdk/powershell/v2025/models/mfa-duo-config
...
```powershell
$MfaDuoConfig = Initialize-PSSailpoint.V2025MfaDuoConfig  -MfaMethod duo-web `
 -Enabled true `
 -VarHost example.com `
