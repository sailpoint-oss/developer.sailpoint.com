...
keywords: ['powershell', 'PowerShell', 'sdk', 'ObjectMappingRequest', 'V2025ObjectMappingRequest'] 
...
```powershell
$ObjectMappingRequest = Initialize-PSSailpoint.V2025ObjectMappingRequest  -ObjectType IDENTITY `
 -JsonPath $.name `
