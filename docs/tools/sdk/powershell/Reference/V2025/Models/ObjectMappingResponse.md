...
keywords: ['powershell', 'PowerShell', 'sdk', 'ObjectMappingResponse', 'V2025ObjectMappingResponse'] 
...
```powershell
$ObjectMappingResponse = Initialize-PSSailpoint.V2025ObjectMappingResponse  -ObjectMappingId 3d6e0144-963f-4bd6-8d8d-d77b4e507ce4 `
 -ObjectType IDENTITY `
 -JsonPath $.name `
