...
keywords: ['powershell', 'PowerShell', 'sdk', 'PasswordOrgConfig', 'V2025PasswordOrgConfig'] 
...
```powershell
$PasswordOrgConfig = Initialize-PSSailpoint.V2025PasswordOrgConfig  -CustomInstructionsEnabled true `
