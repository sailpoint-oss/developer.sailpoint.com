...
keywords: ['powershell', 'PowerShell', 'sdk', 'ProvisioningCriteriaLevel3', 'V2025ProvisioningCriteriaLevel3'] 
slug: /tools/sdk/powershell/v2025/models/provisioning-criteria-level3
...
```powershell
$ProvisioningCriteriaLevel3 = Initialize-PSSailpoint.V2025ProvisioningCriteriaLevel3  -Operation null `
 -Attribute email `
