...
keywords: ['powershell', 'PowerShell', 'sdk', 'Replace', 'V2025Replace'] 
slug: /tools/sdk/powershell/v2025/models/replace
tags: ['SDK', 'Software Development Kit', 'Replace', 'V2025Replace']
---
...
```powershell
$Replace = Initialize-PSSailpoint.V2025Replace  -Regex [^a-zA-Z] `
 -Replacement   `
