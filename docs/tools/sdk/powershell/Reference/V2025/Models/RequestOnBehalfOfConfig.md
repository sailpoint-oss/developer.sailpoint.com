...
keywords: ['powershell', 'PowerShell', 'sdk', 'RequestOnBehalfOfConfig', 'V2025RequestOnBehalfOfConfig'] 
...
```powershell
$RequestOnBehalfOfConfig = Initialize-PSSailpoint.V2025RequestOnBehalfOfConfig  -AllowRequestOnBehalfOfAnyoneByAnyone true `
