...
keywords: ['powershell', 'PowerShell', 'sdk', 'RequestedItemStatusProvisioningDetails', 'V2025RequestedItemStatusProvisioningDetails'] 
...
```powershell
$RequestedItemStatusProvisioningDetails = Initialize-PSSailpoint.V2025RequestedItemStatusProvisioningDetails  -OrderedSubPhaseReferences manualWorkItemDetails
```
