...
keywords: ['powershell', 'PowerShell', 'sdk', 'RevocabilityForRole', 'V2025RevocabilityForRole'] 
...
```powershell
$RevocabilityForRole = Initialize-PSSailpoint.V2025RevocabilityForRole  -CommentsRequired false `
