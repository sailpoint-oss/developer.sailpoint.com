...
keywords: ['powershell', 'PowerShell', 'sdk', 'RoleMembershipIdentity', 'V2025RoleMembershipIdentity'] 
...
```powershell
$RoleMembershipIdentity = Initialize-PSSailpoint.V2025RoleMembershipIdentity  -Type null `
