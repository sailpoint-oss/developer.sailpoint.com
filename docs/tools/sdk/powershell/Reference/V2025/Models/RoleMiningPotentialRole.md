...
keywords: ['powershell', 'PowerShell', 'sdk', 'RoleMiningPotentialRole', 'V2025RoleMiningPotentialRole'] 
...
```powershell
$RoleMiningPotentialRole = Initialize-PSSailpoint.V2025RoleMiningPotentialRole  -CreatedBy null `
 -Density 75 `
