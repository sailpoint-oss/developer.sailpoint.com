...
keywords: ['powershell', 'PowerShell', 'sdk', 'SearchExportReportArguments', 'V2025SearchExportReportArguments'] 
...
```powershell
$SearchExportReportArguments = Initialize-PSSailpoint.V2025SearchExportReportArguments  -Indices [entitlements] `
 -Query name:a* `
