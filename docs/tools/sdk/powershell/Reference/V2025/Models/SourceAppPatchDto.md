...
keywords: ['powershell', 'PowerShell', 'sdk', 'SourceAppPatchDto', 'V2025SourceAppPatchDto'] 
...
```powershell
$SourceAppPatchDto = Initialize-PSSailpoint.V2025SourceAppPatchDto  -Id 2c91808874ff91550175097daaec161c `
 -CloudAppId 9854520 `
 -Name my app `
