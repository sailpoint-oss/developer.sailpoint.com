...
keywords: ['powershell', 'PowerShell', 'sdk', 'SpConfigImportJobStatus', 'V2025SpConfigImportJobStatus'] 
...
```powershell
$SpConfigImportJobStatus = Initialize-PSSailpoint.V2025SpConfigImportJobStatus  -JobId 3469b87d-48ca-439a-868f-2160001da8c1 `
 -Status COMPLETE `
 -Type IMPORT `
