...
keywords: ['powershell', 'PowerShell', 'sdk', 'SubscriptionPatchRequestInnerValue', 'V2025SubscriptionPatchRequestInnerValue'] 
...
```powershell
$SubscriptionPatchRequestInnerValue = Initialize-PSSailpoint.V2025SubscriptionPatchRequestInnerValue 
```
