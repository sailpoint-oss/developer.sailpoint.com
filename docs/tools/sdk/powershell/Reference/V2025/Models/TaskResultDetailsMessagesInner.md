...
keywords: ['powershell', 'PowerShell', 'sdk', 'TaskResultDetailsMessagesInner', 'V2025TaskResultDetailsMessagesInner'] 
...
```powershell
$TaskResultDetailsMessagesInner = Initialize-PSSailpoint.V2025TaskResultDetailsMessagesInner  -Type WARN `
 -VarError false `
 -Warning true `
