...
keywords: ['powershell', 'PowerShell', 'sdk', 'Transform', 'V2025Transform'] 
slug: /tools/sdk/powershell/v2025/models/transform
...
```powershell
$Transform = Initialize-PSSailpoint.V2025Transform  -Name Timestamp To Date `
 -Type dateFormat `
 -Attributes null
```
