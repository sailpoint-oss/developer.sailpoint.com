...
keywords: ['powershell', 'PowerShell', 'sdk', 'UUIDGenerator', 'V2025UUIDGenerator'] 
...
```powershell
$UUIDGenerator = Initialize-PSSailpoint.V2025UUIDGenerator  -RequiresPeriodicRefresh false
```
