...
keywords: ['powershell', 'PowerShell', 'sdk', 'TaskStatus', 'V2026TaskStatus'] 
slug: /tools/sdk/powershell/v2026/models/task-status
...
```powershell
$TaskStatus = Initialize-V2026TaskStatus  -Id id12345 `
 -Type QUARTZ `
 -UniqueName Big Task `
