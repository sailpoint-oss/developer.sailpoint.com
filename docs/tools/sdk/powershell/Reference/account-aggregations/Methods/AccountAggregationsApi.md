...
keywords: ['powershell', 'PowerShell', 'sdk', 'AccountAggregations', 'AccountAggregations'] 
slug: /tools/sdk/powershell/accountaggregations/methods/account-aggregations
...
------------- | ------------- | -------------
[**Get-AccountAggregationStatusV1**](#get-account-aggregation-status-v1) | **GET** `/account-aggregations/v1/{id}/status` | In-progress account aggregation status
...
try {
    Get-AccountAggregationStatusV1 -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-AccountAggregationStatusV1 -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-AccountAggregationStatusV1"
