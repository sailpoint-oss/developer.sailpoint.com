...
slug: /tools/sdk/powershell/accounts/methods/accounts
...
------------- | ------------- | -------------
[**New-AccountV1**](#create-account-v1) | **POST** `/accounts/v1` | Create account
[**Remove-AccountAsyncV1**](#delete-account-async-v1) | **POST** `/accounts/v1/{id}/remove` | Remove account
[**Remove-AccountV1**](#delete-account-v1) | **DELETE** `/accounts/v1/{id}` | Delete account
[**Disable-AccountForIdentityV1**](#disable-account-for-identity-v1) | **POST** `/identities-accounts/v1/{id}/disable` | Disable idn account for identity
[**Disable-AccountV1**](#disable-account-v1) | **POST** `/accounts/v1/{id}/disable` | Disable account
[**Disable-AccountsForIdentitiesV1**](#disable-accounts-for-identities-v1) | **POST** `/identities-accounts/v1/disable` | Disable idn accounts for identities
[**Enable-AccountForIdentityV1**](#enable-account-for-identity-v1) | **POST** `/identities-accounts/v1/{id}/enable` | Enable idn account for identity
[**Enable-AccountV1**](#enable-account-v1) | **POST** `/accounts/v1/{id}/enable` | Enable account
[**Enable-AccountsForIdentitiesV1**](#enable-accounts-for-identities-v1) | **POST** `/identities-accounts/v1/enable` | Enable idn accounts for identities
[**Get-AccountEntitlementsV1**](#get-account-entitlements-v1) | **GET** `/accounts/v1/{id}/entitlements` | Account entitlements
[**Get-AccountV1**](#get-account-v1) | **GET** `/accounts/v1/{id}` | Account details
[**Get-AccountsV1**](#list-accounts-v1) | **GET** `/accounts/v1` | Accounts list
[**Send-AccountV1**](#put-account-v1) | **PUT** `/accounts/v1/{id}` | Update account
[**Submit-ReloadAccountV1**](#submit-reload-account-v1) | **POST** `/accounts/v1/{id}/reload` | Reload account
[**Unlock-AccountV1**](#unlock-account-v1) | **POST** `/accounts/v1/{id}/unlock` | Unlock account
[**Update-AccountV1**](#update-account-v1) | **PATCH** `/accounts/v1/{id}` | Update account
...
try {
    Remove-AccountAsyncV1 -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Remove-AccountAsyncV1 -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-AccountAsyncV1"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Remove-AccountV1 -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Remove-AccountV1 -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-AccountV1"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Disable-AccountForIdentityV1 -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Disable-AccountForIdentityV1 -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Disable-AccountForIdentityV1"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Enable-AccountForIdentityV1 -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Enable-AccountForIdentityV1 -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Enable-AccountForIdentityV1"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-AccountEntitlementsV1 -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-AccountEntitlementsV1 -Id $Id -Limit $Limit -Offset $Offset -Count $Count  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-AccountEntitlementsV1"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    ...
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-AccountV1"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    ...
    # Below is a request that includes all optional parameters
    # Get-AccountsV1 -Limit $Limit -Offset $Offset -Count $Count -DetailLevel $DetailLevel -Filters $Filters -Sorters $Sorters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-AccountsV1"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Submit-ReloadAccountV1 -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Submit-ReloadAccountV1 -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Submit-ReloadAccountV1"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    ...
    Update-AccountV1 -Id $Id -RequestBody $Result 
    
    # Below is a request that includes all optional parameters
    # Update-AccountV1 -Id $Id -RequestBody $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Update-AccountV1"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
