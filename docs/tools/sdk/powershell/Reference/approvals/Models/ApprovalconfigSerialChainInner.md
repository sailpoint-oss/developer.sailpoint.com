...
slug: /tools/sdk/powershell/approvals/models/approvalconfig-serial-chain-inner
...
```powershell
$ApprovalconfigSerialChainInner = Initialize-ApprovalconfigSerialChainInner  -Tier 1 `
