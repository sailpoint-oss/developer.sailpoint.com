...
```powershell
$GetActiveCampaignsV1200ResponseInner = Initialize-GetActiveCampaignsV1200ResponseInner  -Id 2c9079b270a266a60170a2779fcb0007 `
...
```powershell
$GetActiveCampaignsV1200ResponseInner | ConvertTo-JSON
```
