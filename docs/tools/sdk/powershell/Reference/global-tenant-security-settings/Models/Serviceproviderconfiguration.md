...
**FederationProtocolDetails** | [**[]ServiceproviderconfigurationFederationProtocolDetailsInner**](serviceproviderconfiguration-federation-protocol-details-inner) | A list of the abstract implementations of the Federation Protocol details. Typically, this will include on SpDetails object and one IdpDetails object used in tandem to define a SAML integration between a customer's identity provider and a customer's SailPoint instance (i.e., the service provider). | [optional] 

## Examples

- Prepare the resource
```powershell
$Serviceproviderconfiguration = Initialize-Serviceproviderconfiguration  -Enabled true `
 -BypassIdp true `
