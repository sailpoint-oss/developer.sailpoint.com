...
```powershell
$ListIdentityAccessItemsV1200ResponseInner = Initialize-ListIdentityAccessItemsV1200ResponseInner  -Id 2c918087763e69d901763e72e97f006f `
 -AccessType app `
...
```powershell
$ListIdentityAccessItemsV1200ResponseInner | ConvertTo-JSON
```
