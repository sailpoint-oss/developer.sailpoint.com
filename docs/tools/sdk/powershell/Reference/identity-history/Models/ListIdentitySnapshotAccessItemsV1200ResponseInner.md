...
keywords: ['powershell', 'PowerShell', 'sdk', 'ListIdentitySnapshotAccessItemsV1200ResponseInner', 'ListIdentitySnapshotAccessItemsV1200ResponseInner'] 
slug: /tools/sdk/powershell/identityhistory/models/list-identity-snapshot-access-items-v1200-response-inner
...
```powershell
$ListIdentitySnapshotAccessItemsV1200ResponseInner = Initialize-ListIdentitySnapshotAccessItemsV1200ResponseInner  -Id 2c918087763e69d901763e72e97f006f `
 -AccessType role `
 -DisplayName sample `
...
```powershell
$ListIdentitySnapshotAccessItemsV1200ResponseInner | ConvertTo-JSON
```
