...
**SlackTemplate** | [**TemplatedtoSlackTemplate**](templatedto-slack-template) |  | [optional] 
**TeamsTemplate** | [**TemplatedtoTeamsTemplate**](templatedto-teams-template) |  | [optional] 

## Examples

- Prepare the resource
```powershell
$Templatedto = Initialize-Templatedto  -Key cloud_manual_work_item_summary `
