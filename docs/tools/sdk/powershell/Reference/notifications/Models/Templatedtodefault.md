...
keywords: ['powershell', 'PowerShell', 'sdk', 'Templatedtodefault', 'Templatedtodefault'] 
slug: /tools/sdk/powershell/notifications/models/templatedtodefault
...
**SlackTemplate** | [**Templateslack**](templateslack) |  | [optional] 
**TeamsTemplate** | [**Templateteams**](templateteams) |  | [optional] 

## Examples

- Prepare the resource
```powershell
$Templatedtodefault = Initialize-Templatedtodefault  -Key cloud_manual_work_item_summary `
