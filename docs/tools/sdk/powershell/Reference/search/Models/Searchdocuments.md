...
keywords: ['powershell', 'PowerShell', 'sdk', 'Searchdocuments', 'Searchdocuments'] 
slug: /tools/sdk/powershell/search/models/searchdocuments
...
```powershell
$Searchdocuments = Initialize-Searchdocuments  -Description Admin access `
...
```powershell
$Searchdocuments | ConvertTo-JSON
```
