...
keywords: ['powershell', 'PowerShell', 'sdk', 'Resourceobject', 'Resourceobject'] 
slug: /tools/sdk/powershell/sources/models/resourceobject
...
```powershell
$Resourceobject = Initialize-Resourceobject  -Instance null `
