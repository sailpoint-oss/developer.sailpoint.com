...
```powershell
$MachineidentitycreatedMachineIdentity = Initialize-MachineidentitycreatedMachineIdentity  -Id 8cd6c945-0057-4a6e-ad65-9cbf3b3c71b6 `
 -Name TestName `
...
```powershell
$MachineidentitycreatedMachineIdentity | ConvertTo-JSON
```
