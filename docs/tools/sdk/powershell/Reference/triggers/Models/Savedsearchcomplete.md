...
keywords: ['powershell', 'PowerShell', 'sdk', 'Savedsearchcomplete', 'Savedsearchcomplete'] 
slug: /tools/sdk/powershell/triggers/models/savedsearchcomplete
...
**SearchResults** | [**SavedsearchcompleteSearchResults**](savedsearchcomplete-search-results) |  | [required]
...
```powershell
$Savedsearchcomplete = Initialize-Savedsearchcomplete  -FileName Modified.zip `
