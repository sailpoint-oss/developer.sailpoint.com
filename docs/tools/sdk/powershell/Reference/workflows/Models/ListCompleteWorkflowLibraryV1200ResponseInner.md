...
**ExampleOutput** | [**WorkflowlibraryactionExampleOutput**](workflowlibraryaction-example-output) |  | [optional] 
...
```powershell
$ListCompleteWorkflowLibraryV1200ResponseInner = Initialize-ListCompleteWorkflowLibraryV1200ResponseInner  -Id sp:compare-boolean `
...
```powershell
$ListCompleteWorkflowLibraryV1200ResponseInner | ConvertTo-JSON
```
