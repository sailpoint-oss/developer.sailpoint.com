...
keywords: ['powershell', 'PowerShell', 'sdk', 'FullDiscoveredApplications', 'BetaFullDiscoveredApplications'] 
...
```powershell
$FullDiscoveredApplications = Initialize-PSSailpoint.BetaFullDiscoveredApplications  -Id null `
 -Name ExampleApp `
 -DiscoverySource csv `
