...
keywords: ['powershell', 'PowerShell', 'sdk', 'PasswordChangeRequest', 'BetaPasswordChangeRequest'] 
...
```powershell
$PasswordChangeRequest = Initialize-PSSailpoint.BetaPasswordChangeRequest  -IdentityId 8a807d4c73c545510173c545f0a002ff `
