...
[**create_form_definition_by_template**](CustomFormsApi#create-form-definition-by-template) | **POST** `/form-definitions/template` | Create a form definition by template.
