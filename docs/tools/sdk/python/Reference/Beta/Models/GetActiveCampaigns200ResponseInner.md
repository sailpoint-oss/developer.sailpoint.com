...
keywords: ['python', 'Python', 'sdk', 'GetActiveCampaigns200ResponseInner', 'BetaGetActiveCampaigns200ResponseInner'] 
slug: /tools/sdk/python/beta/models/get-active-campaigns200-response-inner
...
**filter** | [**FullcampaignAllOfFilter**](fullcampaign-all-of-filter) |  | [optional] 
**sunset_comments_required** | **bool** | Determines if comments on sunset date changes are required. | [optional] [default to True]
**source_owner_campaign_info** | [**FullcampaignAllOfSourceOwnerCampaignInfo**](fullcampaign-all-of-source-owner-campaign-info) |  | [optional] 
