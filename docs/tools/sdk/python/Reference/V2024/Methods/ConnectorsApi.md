...
[**get_connector_correlation_config**](ConnectorsApi#get-connector-correlation-config) | **GET** `/connectors/{scriptName}/correlation-config` | Get Connector Correlation Configuration
...
[**put_connector_correlation_config**](ConnectorsApi#put-connector-correlation-config) | **PUT** `/connectors/{scriptName}/correlation-config` | Update Connector Correlation Configuration
