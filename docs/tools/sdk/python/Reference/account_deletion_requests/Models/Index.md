---
id: account-deletion-requests-models
title: Models
pagination_label: Models
sidebar_label: Models
sidebar_key: account-deletion-requests-python-models
sidebar_position: 3
sidebar_class_name: models
keywords: ['python', 'Python', 'sdk', 'account-deletion-requests', 'models'] 
slug: /tools/sdk/python/account-deletion-requests/models
tags: ['SDK', 'Software Development Kit', 'account-deletion-requests', 'models']
---
