---
id: auth-users-models
title: Models
pagination_label: Models
sidebar_label: Models
sidebar_key: auth-users-python-models
sidebar_position: 3
sidebar_class_name: models
keywords: ['python', 'Python', 'sdk', 'auth-users', 'models'] 
slug: /tools/sdk/python/auth-users/models
tags: ['SDK', 'Software Development Kit', 'auth-users', 'models']
---
