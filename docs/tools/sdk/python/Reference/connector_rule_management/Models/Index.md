---
id: connector-rule-management-models
title: Models
pagination_label: Models
sidebar_label: Models
sidebar_key: connector-rule-management-python-models
sidebar_position: 3
sidebar_class_name: models
keywords: ['python', 'Python', 'sdk', 'connector-rule-management', 'models'] 
slug: /tools/sdk/python/connector-rule-management/models
tags: ['SDK', 'Software Development Kit', 'connector-rule-management', 'models']
---
