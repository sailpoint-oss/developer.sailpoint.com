---
id: custom-forms-methods
title: Methods
pagination_label: Methods
sidebar_label: Methods
sidebar_key: custom-forms-python-methods
sidebar_position: 3
sidebar_class_name: methods
keywords: ['python', 'Python', 'sdk', 'custom-forms', 'methods'] 
slug: /tools/sdk/python/custom-forms/methods
tags: ['SDK', 'Software Development Kit', 'custom-forms', 'methods']
---
