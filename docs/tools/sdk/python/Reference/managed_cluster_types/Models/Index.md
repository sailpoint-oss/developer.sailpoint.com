---
id: managed-cluster-types-models
title: Models
pagination_label: Models
sidebar_label: Models
sidebar_key: managed-cluster-types-python-models
sidebar_position: 3
sidebar_class_name: models
keywords: ['python', 'Python', 'sdk', 'managed-cluster-types', 'models'] 
slug: /tools/sdk/python/managed-cluster-types/models
tags: ['SDK', 'Software Development Kit', 'managed-cluster-types', 'models']
---
