---
id: mfa-configuration-models
title: Models
pagination_label: Models
sidebar_label: Models
sidebar_key: mfa-configuration-python-models
sidebar_position: 3
sidebar_class_name: models
keywords: ['python', 'Python', 'sdk', 'mfa-configuration', 'models'] 
slug: /tools/sdk/python/mfa-configuration/models
tags: ['SDK', 'Software Development Kit', 'mfa-configuration', 'models']
---
