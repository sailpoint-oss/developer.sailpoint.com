---
id: password-policies-models
title: Models
pagination_label: Models
sidebar_label: Models
sidebar_key: password-policies-python-models
sidebar_position: 3
sidebar_class_name: models
keywords: ['python', 'Python', 'sdk', 'password-policies', 'models'] 
slug: /tools/sdk/python/password-policies/models
tags: ['SDK', 'Software Development Kit', 'password-policies', 'models']
---
