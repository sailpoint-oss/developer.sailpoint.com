---
id: password-sync-groups-models
title: Models
pagination_label: Models
sidebar_label: Models
sidebar_key: password-sync-groups-python-models
sidebar_position: 3
sidebar_class_name: models
keywords: ['python', 'Python', 'sdk', 'password-sync-groups', 'models'] 
slug: /tools/sdk/python/password-sync-groups/models
tags: ['SDK', 'Software Development Kit', 'password-sync-groups', 'models']
---
