---
id: public-identities-config-models
title: Models
pagination_label: Models
sidebar_label: Models
sidebar_key: public-identities-config-python-models
sidebar_position: 3
sidebar_class_name: models
keywords: ['python', 'Python', 'sdk', 'public-identities-config', 'models'] 
slug: /tools/sdk/python/public-identities-config/models
tags: ['SDK', 'Software Development Kit', 'public-identities-config', 'models']
---
