---
id: work-items-methods
title: Methods
pagination_label: Methods
sidebar_label: Methods
sidebar_key: work-items-python-methods
sidebar_position: 3
sidebar_class_name: methods
keywords: ['python', 'Python', 'sdk', 'work-items', 'methods'] 
slug: /tools/sdk/python/work-items/methods
tags: ['SDK', 'Software Development Kit', 'work-items', 'methods']
---
