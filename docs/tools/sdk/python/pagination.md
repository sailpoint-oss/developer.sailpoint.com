...
Here is an example of how to implement pagination with the SDK on line 9:
...
The function takes a few parameters: the first is the function you want to invoke the pagination against. The earlier example calls `AccountsApi(api_client).list_accounts_v1` to list accounts. 
