...
- Your tenant name in ISC. To learn how to find it, refer to [Getting Started](/api/getting-started#find-your-tenant-name). The SDK will use this tenant name to connect to your ISC instance.
