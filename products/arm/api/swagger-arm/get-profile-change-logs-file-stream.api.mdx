---
id: get-profile-change-logs-file-stream
sidebar_label: Gets change logs (in a csv) for an existing EAM profile.
hide_title: true
hide_table_of_contents: true
api: {"tags":["EmergencyAccessManagement"],"operationId":"GetProfileChangeLogsFileStream","parameters":[{"name":"profileId","in":"path","required":true,"schema":{"type":"string","format":"uuid"}}],"responses":{"200":{"description":"Success"},"401":{"description":"Unauthorized"},"403":{"description":"Forbidden"},"404":{"description":"Not Found"},"500":{"description":"Server Error"}},"description":"Gets change logs (in a csv) for an existing EAM profile.","method":"get","path":"/api/eam/profile/{profileId}/ChangeLogs/export","info":{"version":"v1","title":"Access Risk Management ARM Web APIs"},"postman":{"name":"Gets change logs (in a csv) for an existing EAM profile.","description":{"type":"text/plain"},"url":{"path":["api","eam","profile",":profileId","ChangeLogs","export"],"host":["{{baseUrl}}"],"query":[],"variable":[{"disabled":false,"description":{"content":"(Required) ","type":"text/plain"},"type":"any","value":"","key":"profileId"}]},"method":"GET"}}
...
## Gets change logs (in a csv) for an existing EAM profile.
