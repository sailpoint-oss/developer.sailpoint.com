...
api: {"tags":["Customer"],"operationId":"EnableAccessContexts","parameters":[{"name":"customerId","in":"path","description":"Identifier of the customer.","required":true,"schema":{"type":"string","format":"uuid"}}],"responses":{"200":{"description":"Success"},"401":{"description":"Unauthorized"},"403":{"description":"Forbidden"},"404":{"description":"Not Found"},"500":{"description":"Server Error"}},"description":"Enables access contexts for the customer.","method":"patch","path":"/api/accounts/{customerId}/accessContext/enable","info":{"version":"1.0","title":"Access Risk Management Authentication Services"},"postman":{"name":"Enables access contexts for the customer.","description":{"type":"text/plain"},"url":{"path":["api","accounts",":customerId","accessContext","enable"],"host":["{{baseUrl}}"],"query":[],"variable":[{"disabled":false,"description":{"content":"(Required) Identifier of the customer.","type":"text/plain"},"type":"any","value":"","key":"customerId"}]},"method":"PATCH"}}
