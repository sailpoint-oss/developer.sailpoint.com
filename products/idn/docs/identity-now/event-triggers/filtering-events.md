...
If you want to control the test input to validate your filter against a more robust set of data, use the [test invocation](https://developer.sailpoint.com/idn/api/beta/start-test-invocation/) API endpoint.
