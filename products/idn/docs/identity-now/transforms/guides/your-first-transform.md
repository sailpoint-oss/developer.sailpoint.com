...
In this guide, you will learn how to use IdentityNow's Transform REST APIs to do the following:
...
Before you create your first custom transform, see what transforms are already in the tenant. You can get this information by calling the List Transforms API.
...
For more information about creating transforms, see Create Transform.
...
For more information about getting a transform by its `id` see the API Transform by ID.
...
For more information about updating transforms, see Update a transform].
...
For more information about deleting transforms, see the API Delete Transform.
