...
You can make changes to the API you are calling by changing the following line:
...
In the example below on line 17-18 the SDK is set to retry if there is an unexpected error up to 10 times and waits 2 seconds between each retry.
