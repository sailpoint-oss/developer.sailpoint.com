  ...
  nermSideBar: [
    ...
    },
    {
      ...
      link: {
        ...
        title: 'NERM v1 APIs',
        description:
          'These are the Non-employee Risk Management APIs for SailPoint. We encourage you to join the SailPoint Developer Forum at https://developer.sailpoint.com/discuss to connect with other developers using our APIs.',
        slug: '/api/nerm/v1',
      },
