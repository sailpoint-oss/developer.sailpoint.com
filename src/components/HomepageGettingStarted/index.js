      ...
      <div className={styles.mainCard}>
        <div>
          ...
          <div className={styles.gridContainer}>
            <HomepageCard link={"/docs/idn_docs/intro"} title={"Get Started with IdentityNow"} image={"/homepage/cloud.png"}></HomepageCard>
            <HomepageCard link={"/docs/idn_docs/intro"} title={"Get Started with IdentityIQ"} image={"/homepage/cloud.png"}></HomepageCard>
          </div> 
        </div>
