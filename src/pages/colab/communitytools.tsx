...
const CommunityTools: React.FC = () => {
  ...
  return (
    <Layout title="Community Tools" description="The SailPoint Developer Community has everything you need to build, extend, and automate scalable identity solutions.">
      <main>
        <MarketplaceBanner />
