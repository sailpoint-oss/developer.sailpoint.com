...
The [Model Context Protocol (MCP)](https://stackoverflow.blog/2026/05/08/no-dumb-questions-mcp/) is an open standard for connecting AI clients to outside systems:
...
```powershell
$env:SAIL_BASE_URL = "https://your-tenant.api.identitynow.com"
$env:SAIL_CLIENT_ID = "..."
$env:SAIL_CLIENT_SECRET = "..."
```
