...
const API_ERRORS = {
  ...
  'Invalid stored data: missing public key': {
    title: 'Incomplete session',
    message: 'Your sign-in session is missing token encryption data.',
    hint: 'Start sign-in again from your application.',
    severity: 'error',
  },
  'Pickup secret required': {
    title: 'Token pickup requires authorization',
    message: 'The encrypted token can only be retrieved by the application that started sign-in.',
    hint: 'Return to your application and start sign-in again.',
    severity: 'error',
  },
  'Token not found or pickup secret invalid': {
    title: 'Token not available',
    message: 'The token was already picked up, expired, or the pickup secret is invalid.',
    hint: 'Start sign-in again from your application.',
    severity: 'error',
  },
  'Request body too large': {
    title: 'Request too large',
    message: 'The sign-in request was larger than expected and was rejected.',
    hint: 'Start sign-in again from your application.',
    severity: 'error',
  },
  'apiBaseURL must use HTTPS': {
    title: 'Secure URL required',
    message: 'The SailPoint API URL must use HTTPS.',
    hint: 'Check the tenant or vanity URL in your application and try again.',
    severity: 'error',
  },
  'apiBaseURL must not include credentials': {
    title: 'Invalid API URL',
    message: 'The SailPoint API URL must not include embedded credentials.',
    hint: 'Check the tenant or vanity URL in your application and try again.',
    severity: 'error',
  },
  'authorizeEndpoint must use HTTPS': {
    title: 'Secure authorization URL required',
    message: 'The tenant returned an authorization URL that does not use HTTPS.',
    hint: 'Check the tenant or vanity URL in your application and try again.',
    severity: 'error',
  },
  'authorizeEndpoint must not include credentials': {
    title: 'Invalid authorization URL',
    message: 'The tenant returned an authorization URL with embedded credentials.',
    hint: 'Check the tenant or vanity URL in your application and try again.',
    severity: 'error',
  },
  'Unsafe API URL': {
    title: 'Unsafe API URL',
    message: 'The SailPoint API URL resolved to a local or private network address.',
    hint: 'Use a public HTTPS SailPoint tenant or vanity URL.',
    severity: 'error',
  },
